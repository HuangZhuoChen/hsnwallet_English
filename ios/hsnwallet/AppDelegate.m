...
//  [RNUMConfigure initWithAppkey:@"5b3dc5def29d9844d4000011" channel:@"App Store"];
//  [MobClick setScenarioType:E_UM_NORMAL];
  RCTRootView *rootView = [[RCTRootView alloc] initWithBundleURL:jsCodeLocation
                                                      moduleName:@"hsnwallet"
...
//  UIViewController *rootViewController = [UIViewController new];
  ...
  [rootViewController statusShowOrHidden:false];
  [rootViewController changeStyle:false];
