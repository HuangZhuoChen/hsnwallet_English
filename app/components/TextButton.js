    ...
    return (
      <TouchableOpacity
        ...
        {this.props.avatar?<Image source={this.props.avatar} style={{width:ScreenUtil.autowidth(19), height: ScreenUtil.autowidth(15),marginRight:ScreenUtil.autowidth(10),}} resizeMode={'contain'} />:null}
          <Text style={{color:this.props.textColor?this.props.textColor:"#CCCCCC",fontSize:this.props.fontSize?this.props.fontSize:ScreenUtil.setSpText(14),textDecorationLine:this.props.underline?'underline':''}}>{this.props.text}</Text>
        </LinearGradient>
      </TouchableOpacity>
      )
  }
